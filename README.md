# Flare Garden Prototype Step2.5

スマートフォン横画面向けの初期プロトタイプです。
Step2.5では、Step2の水量管理を検証しやすいようにステージ延長、花配置改善、3エリア背景を追加しています。
...
- ゴール位置: 12100
- 小花: 50本
- エリア1 はじまりの花畑: worldX 0〜3000、小花15本
- エリア2 紙の森: worldX 3000〜7900、小花19本
- エリア3 虹の丘: worldX 7900〜12100、小花16本

花はすべて固定配置です。
単独、2本、密集、不規則、高さ違いの配置を混ぜています。
